...
#ifndef _psi_src_lib_libmints_integral_ptq_h_
#define _psi_src_lib_libmints_integral_ptq_h_
...
/*! \ingroup MINTS */
class IntegralFactory_ptq : public IntegralFactory
{
protected:

public:
    /** Initialize IntegralFactory object given a BasisSet for each center. */
    IntegralFactory_ptq(boost::shared_ptr<BasisSet> bs1, boost::shared_ptr<BasisSet> bs2,
    ...
    IntegralFactory_ptq(boost::shared_ptr<BasisSet> bs1, boost::shared_ptr<BasisSet> bs2) : IntegralFactory(bs1, bs2)
    {
    }
    /** Initialize IntegralFactory object given a BasisSet for two centers. Becomes (bs1 bs1 | bs1 bs1). */
    IntegralFactory_ptq(Sboost::shared_ptr<BasisSet> bs1) : IntegralFactory(bs1)
    {
    }

    virtual ~IntegralFactory_ptq()
    {
    }
